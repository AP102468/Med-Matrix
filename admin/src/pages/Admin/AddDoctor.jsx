...
const AddDoctor = () => {
    ...
    //Getting the Backend URl & admin tokem

    const {backendUrl, aToken} = useContext(AdminContext)


    //creating one function which execute when the form submitted and doctor will be added into Database
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            //creating a form data in which we can add these data
            const formData = new FormData()

            //We will store the image into backend. We have to provide the same fieldname that we have provided using multer
            ...
            //Calling Api to save the data into database => We are passing the form data and adminTOken through header sothat authentication will completed and formdata will submitted successfully
    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
        ...
        <div className='bg-white px-8 py-8 border-2 border-gray-100 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
            ...
            <div>
                ...
                <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border border-gray-400 rounded' type="text" placeholder='write about doctor' rows={5} required />
            </div>
