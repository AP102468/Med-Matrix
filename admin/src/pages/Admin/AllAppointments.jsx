...
const AllAppointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
        ...
        <div className='bg-white border border-gray-300 rounded text-sm max-h-[90vh] min-h-[60vh] overflow-y-scroll'>

            {/* By using this structure we will dispaly data in table format */}
